...
private fun NewSaleScreen(onSaved: () -> Unit) {
    ...
    Column(
        ...
        if (selectedProduct != null) {
            Text("পণ্য: " + selectedProduct.name + " | স্টক: " + selectedProduct.stockQuantity)
        }
        ...
        OutlinedTextField(
            ...
            label = { Text("বিক্রয়মূল্য (প্রতি ইউনিট)") },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true
        )
        ...
        Button(
            onClick = {
                ...
                when {
                    ...
                    qty > selectedProduct.stockQuantity -> message = "পর্যাপ্ত স্টক নেই। বর্তমান স্টক: " + selectedProduct.stockQuantity
                    price == null || price < 0 -> message = "সঠিক বিক্রয়মূল্য দিন।"
                    else -> {
            ...
            Text("বিক্রয় সংরক্ষণ করুন ও স্টক কমান")
        }
